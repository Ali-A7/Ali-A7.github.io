...
{% include base_path %}
[Download CV (PDF)]({{ base_path }}files/Resume-Ali-Ahmadi-PhD-AI.pdf)
...
Skills / Tools
======
- Python, PyTorch, CUDA/GPU Computing, Linux, Git, High-Performance Computing :contentReference[oaicite:25]{index=25}  
- Machine Learning, Deep Learning, Computer Vision, Transformers, Representation Learning :contentReference[oaicite:26]{index=26}  
- Reinforcement Learning, Intelligent Agents, Embodied AI, Robotics & Autonomous Systems :contentReference[oaicite:27]{index=27}  
