...
- **Kaggle — Generative AI Style Transfer**  
  Applied GAN-based methods to transfer artistic styles using Claude Monet paintings.

- **LLM Fine-Tuning Research**  
  Studying LoRA, RAG, and Mixture-of-Experts (MoE) for scalable adaptation of LLMs.
